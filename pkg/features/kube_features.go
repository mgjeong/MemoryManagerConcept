...
const (
	...
	// alpha: v1.17
	//
	// Enable container-level memory/hugepage affinity policies for NUMA.
...
var defaultKubernetesFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	TopologyManager:                     {Default: true, PreRelease: featuregate.Alpha}, // TODO(hs2.cho): Turn off flag after debugging.
	MemoryManager:                       {Default: true, PreRelease: featuregate.Alpha}, // TODO(hs2.cho): Turn off flag after debugging.
